...
function TestimonialCarousel({ testimonials }: { testimonials: Testimonial[] }) {
  ...
  useEffect(() => {
    ...
    const currentCards = Array.from(carouselRef.current.querySelectorAll('.testimonial-card-item'));
    ...
    const progressBarFill = carouselRef.current.querySelector('.carousel-progress-fill'); // Assuming this class
    if (progressBarFill) {
      gsap.fromTo(progressBarFill, { width: "0%" }, { width: "100%", duration: 5, ease: "linear" });
    }
...
function HowItWorksSection() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden bg-gradient-to-b from-white via-oz-neutral/10 to-white py-20 md:py-24 how-it-works-section">
      ...
      {/* Decorative Elements */}
      <div className="absolute -right-20 top-20 h-64 w-64 rounded-full bg-oz-accent/10 blur-3xl how-it-works-deco-right" /> {/* Added class */}
      <div className="absolute -left-20 bottom-20 h-64 w-64 rounded-full bg-oz-primary/10 blur-3xl how-it-works-deco-left" /> {/* Added class */}
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    let ctx = gsap.context(() => {
      ...
      if (heroSectionEl) {
        const heroContentWrapper = heroSectionEl.querySelector('.container.mx-auto.px-4.py-6.flex.items-center.h-\\[50vh\\].md\\:min-h-\\[520px\\].md\\:py-18 > div'); // The div containing all hero text and buttons
        const heroBadge = heroContentWrapper?.querySelector('.inline-flex.items-center.gap-1\\.5');
        const heroHeadline = heroContentWrapper?.querySelector('h1');
        const heroSubheadline = heroContentWrapper?.querySelector('p.mt-3.text-sm');
        const heroProcessLine = heroContentWrapper?.querySelector('div.mt-3.text-xs'); // specific class for process line
        const heroCTABtns = heroContentWrapper?.querySelector('div.mt-6.space-y-3 > div'); // The div containing the two Link buttons

        if (heroBadge && heroHeadline && heroSubheadline && heroProcessLine && heroCTABtns) {
          gsap.timeline({ delay: 0.5 }) // Initial delay for page load
            .from(heroBadge, { opacity: 0, y: 20, scale: 0.8, ease: "back.out(1.7)", duration: 0.7 })
            .from(heroHeadline, { opacity: 0, y: 30, ease: "power3.out", duration: 0.8 }, "<0.2")
            .from(heroSubheadline, { opacity: 0, y: 20, ease: "power2.out", duration: 0.7 }, "<0.1")
            .from(heroProcessLine, { opacity: 0, y: 15, ease: "power1.out", duration: 0.6 }, "<0.1")
            .from(heroCTABtns, { opacity: 0, y: 20, ease: "back.out(1.2)", duration: 0.7 }, "<0.2");
        }
      }
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-oz-neutral/5 via-white to-oz-neutral/5 py-20 md:py-24">
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-2">
            <div // Changed from motion.div
              className="subscription-controls-card" // Added class for GSAP targeting
            ...
            <div // Changed from motion.div
              className="subscription-calendar-card" // Added class for GSAP targeting
            >
              <Card className="group h-full overflow-hidden border-oz-neutral/40 bg-white shadow-lg transition-all duration-300 hover:border-oz-primary/40 hover:shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-br from-oz-primary/0 to-oz-accent/0 opacity-0 transition-opacity duration-300 group-hover:opacity-5" />
                <CardHeader className="relative">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-oz-neutral/10 via-white to-oz-neutral/10 py-20 md:py-24">
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div // Changed from motion.div
            className="daily-delivery-header mx-auto max-w-3xl text-center" // Added class for GSAP targeting
          >
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-oz-primary/20 bg-oz-primary/5 px-4 py-1.5 text-sm font-medium text-oz-primary">
              <span className="h-1.5 w-1.5 rounded-full bg-oz-primary" />
              Real-Time Tracking
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-3">
              <svg className="w-6 h-6 text-oz-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
                ...
                <Accordion type="single" collapsible className="w-full">
                  ...
                  >
                    ...
                    <AccordionContent className="text-muted-foreground pb-4 pt-1 text-sm md:text-base leading-relaxed animate-accordion-down">
                      Yes, you can pause your subscription at any time through your dashboard. This gives you the flexibility to take a break whenever you need without losing your meal preferences or account settings. When you're ready to resume, simply reactivate your subscription and your deliveries will continue as scheduled.
                    </AccordionContent>
                  </AccordionItem>
            ...
            <div className="mt-8 text-center">
              ...
              <Link to="/consultation">
                <Button variant="outline" className="border-oz-primary text-oz-primary hover:bg-oz-primary hover:text-white transition-colors">
                  Get in Touch
                </Button>
              </Link>
            </div>
