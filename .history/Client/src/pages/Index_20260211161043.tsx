...
// Framer Motion removed as per request
...
function TestimonialCarousel({
  ...
  // GSAP animation for sliding testimonials
  useEffect(() => {
    if (!carouselRef.current) return;

    // Select current visible cards
    const currentCards = Array.from(
      carouselRef.current.querySelectorAll(".testimonial-card-item"),
    );

    // Animate the cards
    gsap.fromTo(
      currentCards,
      { opacity: 0, x: (idx) => (idx === 0 ? -50 : 50) }, // Initial position based on index
      {
        opacity: 1,
        x: 0,
        duration: 0.6,
    ...
    const progressBarFill = carouselRef.current.querySelector(
  ...
  return (
    <div className="mx-auto mt-12 max-w-5xl" ref={carouselRef}>
      <div className="relative overflow-hidden px-4">
            ...
            <div className="grid h-full gap-6 md:grid-cols-2">
              {[
                ...
                <div
                  ...
                  className="testimonial-card-item" // Added class for GSAP targeting
                >
        ...
        >
          <div // Changed from motion.div
            key={currentIndex}
            className="h-full bg-gradient-to-r from-oz-accent to-oz-accent carousel-progress-fill" // Added class for GSAP targeting
          />
        </div>
      </div>
    </div>
...
function HowItWorksSection() {
  ...
  // Background parallax (desktop only) - will be handled by GSAP later
  ...
  return (
    <section
      ref={sectionRef}
      className="relative overflow-hidden bg-gradient-to-b from-white via-oz-neutral/10 to-white py-20 md:py-24 how-it-works-section"
    >
      {/* Parallax Background Layer */}
      <div // Changed from motion.div
        className="absolute inset-0 bg-gradient-to-br from-oz-primary/5 via-transparent to-oz-accent/5 how-it-works-bg-parallax" // Added class for GSAP targeting
        // style={{ y: backgroundY }} // Removed Framer Motion style
      />
      {/* Decorative Elements */}
      <div className="absolute -right-20 top-20 h-64 w-64 rounded-full bg-oz-accent/10 blur-3xl how-it-works-deco-right" />{" "}
      {/* Added class */}
      <div className="absolute -left-20 bottom-20 h-64 w-64 rounded-full bg-oz-primary/10 blur-3xl how-it-works-deco-left" />{" "}
      {/* Added class */}
      <div className="container relative z-10 mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          <div // Changed from motion.div
            className="how-it-works-header" // Added class for GSAP targeting
          >
...
function StepCard({
  ...
  // Removed Framer Motion: useInView, useScroll, useTransform

  return (
    <div // Changed from motion.div
      ref={cardRef}
      className="group gsap-step-card-element" // Added class for GSAP targeting, original 'group' class preserved
    >
      <Card className="relative h-full overflow-hidden border-oz-neutral/40 bg-white shadow-lg transition-all duration-300 hover:border-oz-primary/40 hover:shadow-2xl">
        ...
        <CardHeader className="relative space-y-4 p-6">
          <div className="flex items-center justify-between">
            ...
            <div // Changed from motion.div
              className="relative inline-flex h-14 w-14 items-center justify-center rounded-xl bg-oz-primary shadow-md transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg step-card-icon-container" // Added class for GSAP
            >
            ...
            <div // Changed from motion.div
              className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-oz-primary/20 bg-gradient-to-br from-white to-oz-neutral/20 text-base font-bold text-oz-primary shadow-sm transition-all duration-300 group-hover:border-oz-primary/50 group-hover:shadow-md step-card-number-badge" // Added class for GSAP
            >
...
const FeaturedMealCard = ({ meal }: { meal: Meal }) => {
  ...
  return (
    <Link to={`/meal-packs/${meal.slug || meal.id}`} className="group block">
      <Card className="gsap-card h-full border-2 border-oz-primary/10 bg-white shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:border-oz-accent overflow-hidden">
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    let ctx = gsap.context(() => {
      ...
      const testimonialSection = document.querySelector('.gsap-testimonials-section');
      if (testimonialSection) {
        const testimonialBadge = testimonialSection.querySelector('.gsap-section-header .mb-4.inline-flex');
        if (testimonialBadge) {
      ...
      const trustSection = document.querySelector('.trust-quality-assurance-section');
      if (trustSection) {
        const trustCards = gsap.utils.toArray(trustSection.querySelectorAll('.gsap-trust-icon-container'));
        ...
        trustCards.forEach((iconContainer: any) => {
          ...
          iconContainer.addEventListener('mouseleave', () => hoverTween.reverse());
        });
      ...
      if (faqSection) {
        ...
        const accordionItems = gsap.utils.toArray(faqSection.querySelectorAll('.gsap-faq-accordion-item'));
        ...
        const accordionTriggers = gsap.utils.toArray(faqSection.querySelectorAll('.gsap-faq-accordion-trigger'));
    ...
    // Cleanup
    return () => {
      if (ctx) ctx.revert(); // Revert all animations in this context
    };
  }, []);
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="bg-oz-primary py-16 text-white gsap-build-your-own-section">
        <div className="container mx-auto px-4">
          <div className="grid items-center gap-8 lg:grid-cols-2">
            ...
            <Card className="border-white/10 bg-white/5 text-white shadow-lg backdrop-blur gsap-build-your-own-card">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-xl border border-white/10 bg-black/20 px-3 py-3 text-sm gsap-ingredient-item"
                    >
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-oz-neutral/5 via-white to-oz-neutral/5 py-20 md:py-24">
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-2">
            <div
              className="subscription-controls-card gsap-subscription-card" // Added class for GSAP targeting
            >
              {" "}
            ...
            <div
              className="subscription-calendar-card gsap-subscription-card" // Added class for GSAP targeting
            >
              <Card className="group h-full overflow-hidden border-oz-neutral/40 bg-white shadow-lg transition-all duration-300 hover:border-oz-primary/40 hover:shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-br from-oz-primary/0 to-oz-accent/0 opacity-0 transition-opacity duration-300 group-hover:opacity-5" />
                <CardHeader className="relative">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-oz-neutral/10 via-white to-oz-neutral/10 py-20 md:py-24">
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div
            className="daily-delivery-header mx-auto max-w-3xl text-center gsap-section-header" // Added class for GSAP targeting
          >
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-oz-primary/20 bg-oz-primary/5 px-4 py-1.5 text-sm font-medium text-oz-primary">
              <span className="h-1.5 w-1.5 rounded-full bg-oz-primary" />
              Real-Time Tracking
          ...
          <div // Changed from motion.div
            className="daily-delivery-card-container mx-auto mt-16 max-w-5xl" // Added class for GSAP targeting
          >
            {" "}
              ...
              <CardContent className="relative p-8 md:p-10">
                <div className="grid gap-8 md:grid-cols-4">
                  {[
                    ...
                    <div // Changed from motion.div
                      key={step.title} // Preserve key for React
                      className="group/step relative daily-delivery-step" // Added class for GSAP targeting
                    >
                      ...
                      <div className="relative">
                        <div className="mb-4 flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-oz-primary/10 to-oz-accent/10 shadow-md transition-all duration-300 group-hover/step:scale-110 group-hover/step:shadow-lg gsap-delivery-step-icon-container">
                              <span className="text-2xl">{step.icon}</span>
                            </div>
                            <div>
                              <div className="text-sm font-bold text-oz-primary gsap-delivery-step-title">
                                {step.title}
                              </div>
                        ...
                        <div className="relative h-4 overflow-hidden rounded-full bg-gradient-to-r from-oz-neutral/20 to-oz-neutral/10 shadow-inner">
                          <div className="h-full rounded-full bg-gradient-to-r from-oz-accent via-oz-accent to-oz-accent shadow-lg">
                            <div className="h-full w-full animate-pulse bg-white/20" />
                          </div>
                          {step.progress > 0 && (
                            <div className="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] font-bold text-white">
                              {step.progress}%
                            </div>
                          )}
                        </div>
                      ...
                      {index < 3 && (
                        <div className="absolute -right-4 top-10 hidden h-px w-8 md:block">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-r from-oz-accent to-transparent" />
                        </div>
                      )}
                    </div> // Changed from motion.div
                  ))}
          ...
          <div className="gsap-consultation-card-wrapper">
            <Card className="group relative overflow-hidden border-2 border-oz-primary/30 bg-gradient-to-br from-oz-neutral/30 via-oz-primary/5 to-oz-accent/10 shadow-xl transition-all duration-500 hover:shadow-2xl">
              ...
              <CardContent className="relative grid items-center gap-8 p-8 md:grid-cols-[1fr_auto] md:p-12">
                <div>
                  {/* Badge */}
                  <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-oz-primary/20 to-oz-accent/20 px-4 py-1.5 text-sm font-semibold text-oz-primary shadow-sm">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-oz-neutral/30 via-oz-primary/5 to-oz-accent/10 py-20 gsap-testimonials-section">
      ...
      <section className="relative overflow-hidden bg-white py-20 trust-quality-assurance-section">
        {/* Decorative elements */}
              ...
              <div key={title}>
                <Card className="gsap-card group h-full border-2 border-oz-neutral/20 bg-gradient-to-br from-white to-oz-neutral/5 shadow-md transition-all duration-300 hover:-translate-y-1 hover:border-oz-primary/30 hover:shadow-xl">
                  <CardHeader className="space-y-3 pb-5">
                    <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-oz-primary/10 to-oz-accent/10 transition-all duration-300 group-hover:from-oz-primary/20 group-hover:to-oz-accent/20 gsap-trust-icon-container">
      ...
      {/* FAQs */}
      <section className="relative overflow-hidden bg-gradient-to-br from-oz-neutral/10 via-white to-oz-neutral/5 py-16 md:py-20" faqs-section">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="gsap-section-header mx-auto max-w-3xl text-center mb-10 md:mb-12">
            ...
            <Card className="border-0 bg-white shadow-lg rounded-xl overflow-hidden">
              <CardContent className="p-4 md:p-6">
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem
                    value="pause"
                    className="gsap-faq-accordion-item border-b border-oz-neutral/20 last:border-0 transition-colors duration-200 hover:bg-oz-primary/[0.02] data-[state=open]:bg-oz-primary/[0.03] data-[state=open]:border-l-4 data-[state=open]:border-l-oz-primary data-[state=open]:pl-3"
                  >
                    <AccordionTrigger className="gsap-faq-accordion-trigger text-oz-primary font-semibold hover:no-underline py-4 text-base md:text-lg transition-all">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-oz-primary via-oz-secondary to-oz-primary py-20 text-white md:py-24">
        ...
        <div className="container relative mx-auto px-4">
          <div className="gsap-section-header mx-auto max-w-3xl text-center">
            {/* Badge */}
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/10 px-5 py-2 text-sm font-semibold text-white shadow-lg backdrop-blur-sm">
              <span className="text-base">🚀</span>
              Ready to Transform?
            </div>
