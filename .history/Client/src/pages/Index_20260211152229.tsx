              ...
              <div key={title}>
                <Card className="gsap-card group h-full border-2 border-oz-neutral/20 bg-gradient-to-br from-white to-oz-neutral/5 shadow-md transition-all duration-300 hover:-translate-y-1 hover:border-oz-primary/30 hover:shadow-xl">
                  <CardHeader className="space-y-3 pb-5">
                    <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-oz-primary/10 to-oz-accent/10 transition-all duration-300 group-hover:from-oz-primary/20 group-hover:to-oz-accent/20">
